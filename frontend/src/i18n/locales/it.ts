...
export const it = {
  ...
  'plan.unassigned_one': 'Un luogo ha una posizione ma nessuna tappa.',
  'plan.unassigned_other': '{count} luoghi hanno una posizione ma nessuna tappa.',
  ...
  'packing.clearDone_one': 'Togli quella già fatta',
  'packing.clearDone_other': 'Togli le {count} già fatte',
