...
export const it = {
  ...
  'bookings.none': 'Nessuna prenotazione.',
  'bookings.noneHint': 'Voli, hotel, treni: quello che hai già fissato. Da qui puoi anche allegare le conferme, così le hai anche senza rete.',
  'bookings.add': 'Aggiungi prenotazione',
  'bookings.noDate': 'senza data',
  'bookings.noPapers': 'Nessun documento allegato',
  'bookings.papers_one': 'Un documento',
  'bookings.papers_other': '{count} documenti',
  'spine.none': 'Aggiungi la prima città',
  'trip_plan.willLook': 'Non hai ancora luoghi: ne cerco io',
  'theme.legend': 'Che giornata vuoi che sia',
  'theme.sights': 'Da vedere',
  'theme.museums': 'Musei',
  'theme.shopping': 'Negozi',
  'theme.food': 'Mangiare',
  'theme.outdoors': 'All’aperto',
  'tabs.trip': 'Viaggio',
  ...
  'model.intro': 'Il modello sul telefono può dire quali luoghi stanno bene insieme in una giornata di un certo tipo. Non aggiunge né toglie posti: dà solo un parere, e decidi tu ricalcolando.',
  ...
  'model.ratedFor': 'Ha detto la sua su {count} luoghi per le giornate «{theme}». Ricalcola il piano per vederne l’effetto.',
  ...
  'login.subtitle': 'Il tuo viaggio giorno per giorno — itinerario, documenti, spese — e funziona anche senza rete.',
  ...
  'today.days_one': '{count} giorno',
  'today.days_other': '{count} giorni',
  'today.dayOf': 'Giorno {day} di {total}',
  'today.wereBack': 'Sei tornata',
  'today.daysAgo_one': '{count} giorno fa',
  'today.daysAgo_other': '{count} giorni fa',
  'today.stillToDo': 'Manca ancora',
  'today.pending_one': '{count} prenotazione da confermare',
  'today.pending_other': '{count} prenotazioni da confermare',
  ...
  'today.documents_one': '{count} documento non ancora sul telefono',
  'today.documents_other': '{count} documenti non ancora sul telefono',
  ...
  'locate.working': 'Cerco… {done} di {total}',
  'locate.found_one': 'Trovata la posizione di un luogo.',
  'locate.found_other': 'Trovate le posizioni di {count} luoghi.',
  'locate.foundNone': 'Nessuna posizione trovata. Puoi aggiungerle a mano aprendo il luogo.',
  'places.noneHint': 'Senza luoghi non c’è niente da organizzare, e la mappa resta vuota. Puoi incollarli da Google Maps, o farteli proporre.',
  'places.noneUnlocated': 'Prima serve una tappa con la posizione: è da lì che l’app sa dove cercare.',
  'places.goToStops': 'Vai alle tappe',
  'stops.noneHint': 'È il primo passo. Meteo, mappa, suggerimenti e distribuzione dei giorni misurano tutti da qui.',
  'map.noPositions': 'I luoghi che hai salvati non hanno una posizione, quindi non c’è niente da disegnare.',
  'map.noPlaces': 'Non hai ancora salvato nessun luogo.',
  'map.goFindPositions': 'Trova le posizioni',
  'map.goAddPlaces': 'Aggiungi dei luoghi',
  'booking.words.travel.title': 'Numero o nome',
  'booking.words.travel.start': 'Partenza',
  'booking.words.travel.end': 'Arrivo',
  'booking.words.hotel.title': 'Nome dell’hotel',
  'booking.words.hotel.start': 'Check-in',
  'booking.words.hotel.end': 'Check-out',
  'booking.words.car.title': 'Noleggio',
  'booking.words.car.start': 'Ritiro',
  'booking.words.car.end': 'Riconsegna',
  'booking.words.restaurant.title': 'Ristorante',
  'booking.words.restaurant.start': 'Ora del tavolo',
  'booking.words.restaurant.end': 'Fine (se la sai)',
  ...
  'trip.field.where': 'Dove vai?',
  'trip.whereHint': 'Scegli un suggerimento e ti creo anche la prima tappa, con posizione e fuso orario.',
  'trip.whereFound': 'Bene: creo anche la prima tappa, con posizione e fuso orario.',
  'taste.label': 'Descrivi cosa ti piace',
  'taste.placeholder': 'posti tranquilli, si mangia bene, odio le code',
  'taste.hint': 'Riordina la lista con un modello che gira sul telefono: la prima volta scarica qualche centinaio di MB, poi funziona anche senza rete. Niente esce da qui.',
  'taste.sort': 'Riordina così',
  'taste.loading': 'Scarico il modello… {percent}%',
  'taste.thinking': 'Sto leggendo la lista…',
  'taste.applied': 'Riordinati {n} luoghi. Sotto restano quelli che non ha giudicato.',
  'taste.failed': 'Non è riuscito a girare qui. La lista resta com’era.',
  'leg.estimated': 'Tempo stimato. Toccalo per dire quanto ci vuole davvero.',
  'leg.known': 'Tempo che hai verificato tu.',
  'leg.realMinutes': 'Minuti reali',
  'timeline.day': 'Giorno {n}',
  'timeline.hasDocuments': 'Ha dei documenti',
  'timeline.addNote': 'Aggiungi una nota',
  ...
  'map.nothingToShow': 'Niente da mostrare sulla mappa',
  ...
  'places.cityInferred': 'città dedotta',
  'places.noStop': 'Nessuna tappa',
  'places.none': 'Nessun luogo salvato.',
  'places.choose': 'Scegline più di uno',
  'places.allOfThem': 'Seleziona tutti',
  'places.noneOfThem': 'Deseleziona tutti',
  'places.deleteChosen': 'Elimina ({count})',
  'places.confirmMany': 'Elimino {count} luoghi? Non si torna indietro.',
  'place.plannedFor': 'In programma {day} alle {time}',
  'place.notPlanned': 'Non ancora in programma.',
  'places.stop': 'Città',
  ...
  'weather.unlocated_one': 'Una tappa non ha coordinate, quindi per lei non si può chiedere il meteo. Aprila e premi «Trova le posizioni».',
  'weather.unlocated_other': '{count} tappe non hanno coordinate, quindi per loro non si può chiedere il meteo. Aprile e premi «Trova le posizioni».',
